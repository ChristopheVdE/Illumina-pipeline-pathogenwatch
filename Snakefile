...
rule copy_files:
    ...
    shell:
        "docker run -it --mount src={origin},target=/home/rawdata/,type=bind --mount src=`pwd`,target=/home/Pipeline/,type=bind christophevde/ubuntu_bash:1.0 /home/Scripts/01_copy_rawdata.sh"
